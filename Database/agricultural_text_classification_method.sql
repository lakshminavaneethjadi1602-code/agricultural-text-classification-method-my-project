...
--
-- Host: localhost
-- Generation Time: Aug 15, 2023 at 07:35 AM
...
--
-- Database: `agricultural_text_classification_method`
--
CREATE DATABASE IF NOT EXISTS `agricultural_text_classification_method` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `agricultural_text_classification_method`;
...
--
-- Table structure for table `remote_user_agriculture_text_classification`
--

CREATE TABLE IF NOT EXISTS `remote_user_agriculture_text_classification` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `remote_user_agriculture_text_classification`
--

INSERT INTO `remote_user_agriculture_text_classification` (`id`, `Fid`, `State_Name`, `District_Name`, `Crop_Year`, `Season`, `Crop`, `Area`, `Production`, `Prediction`) VALUES
(1, '10.42.0.211-66.102.255.40-51278-443-6', 'Andaman and Nicobar Islands', 'NICOBARS', '2017', 'Whole Year ', '', '46', '100', 'Others'),
(2, '10.42.0.151-10.42.0.1-10155-53-17', 'Andhra Pradesh', 'ANANTAPUR', '2019', 'Rabi ', '', '300', '200', 'Wheat'),
(3, '169.45.248.168-10.42.0.211-443-51959-6', 'Andhra Pradesh', 'ANANTAPUR', '2017', 'Rabi', '', '307', '213', 'Wheat');
...
(3, 'Gopikrishnan', 'Gopikrishnan123@gmail.com', 'Gopikrishnan', '9535866270', 'India', 'Karnataka', 'Bangalore', '#9029,4th Cross,Rajajinagar', 'Male'),
(4, 'Manjunath', 'tmksmanju19@gmail.com', 'Manjunath', '9535866270', 'India', 'karnataka', 'Bangalore', '#8928,15th Cross,Malleshwaram', 'Male'),
(5, 'tmksmanju', 'tmksmanju19@gmail.com', 'tmksmanju', '9535866270', 'India', 'Karnataka', 'Bangalore', '#8928,4th Cross,Rajajinagar', 'Male');
...
(12, 'Mul Convolution Kernel Convolutional Neural Network (Mul-CNN)', '94.44444444444444'),
(13, 'Gradient Boosting Classifier', '95.41062801932367');
...
(11, 'Wheat', '66.66666666666666'),
(12, 'Others', '33.33333333333333');
