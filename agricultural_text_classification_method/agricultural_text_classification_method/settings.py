...
ROOT_URLCONF = 'agricultural_text_classification_method.urls'
...
WSGI_APPLICATION = 'agricultural_text_classification_method.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'agricultural_text_classification_method',
        'USER':'root',
        'PASSWORD': '',
        'HOST' :'127.0.0.1',
        'PORT' :'3306',
